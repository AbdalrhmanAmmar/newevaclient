...
export const metadata: Metadata = {
  ...
  title: "إيفا للأمن والسلامة | أنظمة إنذار ومكافحة الحريق والمراقبة المعتمدة",
  description:
    "إيفا للأمن والسلامة - شركة رائدة في توريد وتركيب وصيانة أنظمة الأمن والسلامة. أنظمة إنذار الحريق، كاميرات المراقبة، طفايات الحريق، وخدمات السلامة المهنية المعتمدة من الدفاع المدني.",
  keywords: [
"تصريح الدفاع المدني",
"محلات السلامة",
"دفاع مدني",
...
"شهادة أمن وسلامة معتمدة"
  ...
  openGraph: {
    type: "website",
    url: siteUrl,
    title: "إيفا للأمن والسلامة - أنظمة الحماية المعتمدة",
    description:
      "حلول أمن وسلامة متكاملة ومعتمدة: أنظمة إنذار الحريق، كاميرات المراقبة، صيانة طفايات الحريق، وخدمات السلامة المهنية.",
    siteName: "إيفا للأمن والسلامة",
    images: [{ url: `${siteUrl}/og.jpg`, width: 1200, height: 630, alt: "إيفا للأمن والسلامة" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "إيفا للأمن والسلامة - خدمات معتمدة",
    description:
      "شركة متخصصة في توريد وتركيب وصيانة أنظمة الأمن والسلامة. خدمات معتمدة من الدفاع المدني.",
