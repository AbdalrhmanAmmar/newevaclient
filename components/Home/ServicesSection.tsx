...
"لايف سيفتي ( إنارة إحتياطية - أبواب طوارئ - لوحات ارشادية - نقاط التجمع )",
  ...
  { 
    icon: '🧯', 
    title: "صيانة وتعبئة طفايات الحريق",
    slug: "fire-extinguisher-maintenance",
    description: "خدمات صيانة وتعبئة طفايات الحريق لضمان جاهزيتها للاستخدام الفوري",
    features: [
      "فحص دوري شامل لحالة الطفايات",
      "تعبئة جميع أنواع طفايات الحريق",
      "استبدال القطع التالفة والمستهلكة",
      "إصدار شهادات صيانة معتمدة",
      "خدمة سريعة في الموقع",
      "ضمان جودة العمل والمواد"
]
  }
];
